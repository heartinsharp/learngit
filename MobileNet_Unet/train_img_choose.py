...
test_img_path = '/home/ymh/桌面/U-net/mobilenet/datasets/img'
test_label_path = '/home/ymh/桌面/U-net/mobilenet/datasets/label'
# train_img_path = '/home/ymh/桌面/U-net/data/val_image'
# train_label_path = '/home/ymh/桌面/U-net/data/val_label'


img_list = readfile(img_path)
print(len(img_list))
a = random.sample(img_list, 10000)
a = np.unique(a)
...
for i in range(len(a)):
    ...
    if 100 in lis:
        ...
        cv2.imwrite(test_label_path + "/" + a[i].split(".", 1)[0] + '.png', mask)
print(num)
print("complete!")
